...
const OUTREACH_SIGNUP_FIELDS: FormTemplateField[] = [
  ...
  {
    label: 'Phone number',
    description: 'Ghana mobile number — helps us follow up and avoid duplicate sign-ups',
    field_type: 'phone',
    required: true,
    prefill_key: 'phone',
    sort_order: 1,
  ...
  {
    label: 'Where did we meet you?',
    description: 'Event, campus, street outreach, online, etc.',
    field_type: 'short_text',
    required: false,
    prefill_key: 'where_we_met',
    sort_order: 5,
  },
  {
    label: 'How did you join / connect with us?',
    field_type: 'dropdown',
    required: false,
    prefill_key: 'how_joined',
    options: [
      'Friend invited me',
      'Walked in during outreach',
      'Social media',
      'Campus visit',
      'Church service',
      'Camp meeting',
      'WhatsApp / online group',
      'Other',
    ],
    sort_order: 6,
  },
  {
    label: 'Tags',
    description: 'Pick words or phrases that describe this contact (select all that apply)',
    field_type: 'checkbox',
    required: false,
    prefill_key: 'contact_tags',
    options: [
      'First-time contact',
      'Returning visitor',
      'Student',
      ...
      'Needs follow-up',
      'Interested in RLC',
      'Interested in campus fellowship',
      'Referred someone',
    ],
    sort_order: 7,
  },
  {
    label: 'Other tags or notes',
    description: 'Comma-separated words or phrases peculiar to this person',
    field_type: 'short_text',
    required: false,
    sort_order: 8,
  },
  {
    label: 'Are you currently a student or working?',
    field_type: 'radio',
    required: false,
    prefill_key: 'employment_status',
    options: ['Student', 'Working', 'Both student and working', 'Neither right now'],
    sort_order: 9,
  },
  {
  ...
  {
    label: 'Level / year',
    description: 'If you are a student — e.g. Level 100, SHS 2',
    field_type: 'short_text',
    required: false,
  ...
  },
  {
    ...
    description: 'If you are working',
    field_type: 'short_text',
    required: false,
    prefill_key: 'workplace_name',
    sort_order: 13,
  },
  {
