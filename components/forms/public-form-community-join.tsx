  ...
  return (
    <section className="overflow-hidden rounded-xl border border-slate-200/90 bg-white shadow-[0_1px_3px_rgba(15,23,42,0.06)]">
      <div className="border-b border-slate-100 bg-gradient-to-r from-slate-50 to-indigo-50/60 px-5 py-4">
        <h2 className="text-base font-semibold text-slate-900">Stay connected with Campus Gem</h2>
        <p className="mt-1 text-sm text-slate-600">
          You&apos;re registered — join our community channels for prayer, Bible study, and updates.
        </p>
      </div>
